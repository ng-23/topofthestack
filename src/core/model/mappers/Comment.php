...
use tots\Entities\Comments\Comment;
use tots\Entities\Comments\CommentFactory;
use PDO;
...
class CommentMapper extends DataMapper
{
    ...
    public function deleteByCommentorId(int $commentor_id): array
    {
        $comments = [];
    ...
    public function deleteByBlogId(int $blog_id): array
    {
        $comments = [];
