...
use tots\Entities\Users\User;
use tots\Entities\Users\UserFactory;
...
class UserMapper extends DataMapper
{
    ...
    /**
     * Should there be fetch methods in here like fetchFollowersByUserId and fetchFollowingByUserId
     * or should that be its own mapper, like FollowersMapper.php
     * The same argument could be made to merge BlogLike mapper with Blog mapper
     * And since those are separate, I say Followers mapper is also separate (for now, at least...)
     */
    ...
    {
        // is it cheaper/better to do this check or just run the query even though it won't return anything?
        // these types of checks are redundant in cases where params like display_name are valid because
        // the entity's setters will do the exact same checks again
        // if i took entities as params, i would not have to do these checks in the methods
        // though i'd still have to do null checks but that's ok
