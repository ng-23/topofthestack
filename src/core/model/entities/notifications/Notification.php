...
namespace tots\Entities\Notifications;
...
use Exception;
use LengthException;
use tots\Mappers\NotificationMapper;
use ReflectionClass;
use tots\Exceptions\BadFileUploadException;
use tots\Exceptions\BadNotificationTypeException;
...
class Notification extends Entity
{
    ...
    public function setType(int $type)
    {
        ...
        if (!$is_valid) {
            // BadNotificationTypeException
            throw new BadNotificationTypeException();
        }
    }
